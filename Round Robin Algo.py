class ProcessControlBlock:
    def __init__(self, pid, arrival_time, execution_time, quantum_size):
        self.pid = pid
        ...
        self.resources = None
        self.resume_instruction_address = 0
...
def main():
    ...
    for pid in range(1, num_processes + 1):
        ...
        processes.append(ProcessControlBlock(pid, arrival_time, execution_time, time_quantum))
